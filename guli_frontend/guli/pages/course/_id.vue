<template>
          ...
          <aside class="c-attr-wrap">
            <section class="ml20 mr15">
              ...
              <section class="c-attr-mt c-attr-undis">
                <span class="c-fff fsize14">主讲： {{ courseWebVo.price }}&nbsp;&nbsp;&nbsp;</span>
              </section>
            ...
            <ol class="thr-attr-ol clearfix">
              <li>
                ...
                <aside>
                  ...
                  <br>
                  <h6 class="c-fff f-fM mt10">{{ courseWebVo.price }}</h6>
                </aside>
              </li>
              <li>
                <p>&nbsp;</p>
  ...
  export default {
    ...
    asyncData({params, error}) {
      ...
      //   }
      // })
      return axios.get("http://localhost:8001/eduservice/coursefront/getCourseFrontInfo/" + params.id).then((res) => {
        return {
